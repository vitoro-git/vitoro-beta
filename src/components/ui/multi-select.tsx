        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex justify-between items-center bg-inherit hover:bg-inherit p-1 border rounded-md h-auto min-h-10 [&_svg]:pointer-events-auto",
                ...
                <div className="flex justify-between items-center w-full">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="hover:bg-white/20 -m-0.5 ml-2 p-0.5 rounded-sm focus:outline-none focus:ring-1 focus:ring-white/50 w-4 h-4 cursor-pointer"
                            >
                              <XCircle
                                className={cn(
                                  "w-3 h-3",
                  ...
                  <div className="flex justify-between items-center">
                    <div
                      ...
                      className="flex justify-center items-center mx-2 rounded-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 w-4 h-4 text-muted-foreground hover:text-foreground cursor-pointer"
                    >
